...
export const AchievementsIcon = () => (
  ...
  >
    <path
      fill="#A7A7A7"
      d="M7.517 13.558 10 12.052l2.483 1.506-.66-2.825 2.196-1.885-2.886-.256L10 5.942l-1.133 2.65-2.886.256 2.196 1.885-.66 2.825ZM10 19.916 7.073 17H3v-4.073L.084 10 3 7.073V3h4.073L10 .085 12.927 3H17v4.073L19.916 10 17 12.927V17h-4.073L10 19.916Zm0-1.416 2.5-2.5H16v-3.5l2.5-2.5L16 7.5V4h-3.5L10 1.5 7.5 4H4v3.5L1.5 10 4 12.5V16h3.5l2.5 2.5Z"
    />
  </svg>
)
